export default function() {
    ...
    beveragesHeader.classList.add("beveragesHeader");
    beveragesHeader.textContent = "Beverages";
    const beveragesMenu = document.createElement("div");
    beveragesMenu.classList.add("beveragesMenu");
    ...
    dessertsSection.classList.add("dessertsSection");
    const dessertsHeader = document.createElement("div");
    dessertsHeader.classList.add("dessertsHeader");
